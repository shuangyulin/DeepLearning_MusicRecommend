...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        if tableName.lower() == "gequxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/shoucang'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_shoucang".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "gequxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/share'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_share".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "gequxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/pinglun'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_pinglun".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "gequxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/bofang'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_bofang".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "gequxinxi":
            urlpatterns.extend(
...
#预测
        if tableName.lower() == "gequxinxiforecast":
            urlpatterns.extend(
                       [
