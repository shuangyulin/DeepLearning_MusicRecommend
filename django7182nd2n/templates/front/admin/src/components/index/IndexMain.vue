<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"20px 0 0 180px","margin":"0","position":"relative","background":"#e1e1e1","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px","boxShadow":"none","borderColor":"#f6f6f6","margin":"0 auto","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-start","top":"0","borderRadius":"10px","left":"0px","background":"#0d0d0d","borderWidth":"0px","width":"calc(100% - 60px)","fontSize":"16px","position":"inherit","borderStyle":"solid","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"15px 20px 15px","margin":"15px auto","borderColor":"#3b6885","borderRadius":"8px","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 60px)","fontSize":"15px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
