...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
		color: #fff !important;
		background: url(http://codegen.caihongy.cn/20241123/66fc3913310b4087b51bb2ae0b18ed98.png) no-repeat left center / 100% 100% !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.home>.el-tooltip:hover {
		color: #fff;
		background: url(http://codegen.caihongy.cn/20241123/66fc3913310b4087b51bb2ae0b18ed98.png) no-repeat left center / 100% 100%;
	}
